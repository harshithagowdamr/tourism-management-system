	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">
		 <div class="col-md-4 about-grids">
			 ...
			 <p>We envision a world where growth and development go hand in hand with care and respect for people and the environment. Our goal is to create a future where progress is measured not only by economic success but also by the well-being of communities and the preservation of natural resources. </p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4><span class="icon2"></span>Our Mission</h4>
			 <p>Our mission is to promote tourism that uplifts and supports local communities, ensuring they directly benefit from its growth. We are committed to addressing and challenging harmful practices that exploit people or the environment. By fostering ethical and sustainable approaches, we aim to create tourism experiences that are fair and responsible. </p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4><span class="icon3"></span>Safety Information</h4>
			 <p>Your safety is our top priority, and we are dedicated to creating a secure environment for everyone. We take proactive measures to identify and address potential risks promptly and effectively. Clear guidelines and best practices are in place to ensure your peace of mind during every interaction. </p>
...
<form method="post">
                      ...
                      <tr><td align="right" style="text-decoration-color: #000;"> <input    name="t1"  placeholder="Enter Your Name" type="text" title"Please Enter Only Characters and numbers between 1 to 50 for Name"></td></tr>
                      <tr><td align="right" style="text-decoration-color: #000;"><input  name="t2"  placeholder="Enter Contact No"  type="text"  required pattern="[0-9]{10,12}" title"Please Enter Only  numbers between 10 to 12 for Contact no"></td></tr>
					 <tr><td align="right" style="text-decoration-color: #000;"> <input  name="t3" placeholder="Enter Email" type="text"  required></td></tr>
					 <tr><td style="text-decoration-color: #000;"><textarea  name="t4"  placeholder="Enter Message Here"  type="text"  required/ ></textarea></td></tr>
